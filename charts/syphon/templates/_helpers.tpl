...
name: {{ include "syphon.fullname" . }}-{{ include "syphon.config" . | toJson | sha256sum | trunc 10 }}
{{- end -}}
...
{{/* Generate List of volumes to attact to container */}}
{{- define "syphon.volumes" -}}
- name: config-volume
  configMap: {{- include "syphon.configMapName" . | nindent 4 }}
